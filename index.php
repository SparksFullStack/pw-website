...
<nav class="navbar navbar-expand-md navbar-light fixed-top">
  <div class="container">
    <a href="#home" class="navbar-brand">
      <h3 class="d-inline align-middle">Permwaze</h3>
    </a>
    ...
    <div class="collapse navbar-collapse" id="navbarCollapse">
      <ul class="navbar-nav ml-auto">
        ...
        <li class="nav-item">
          <a href="#about" class="nav-link">Showcase</a>
        </li>
        <!-- <li class="nav-item">
          <a href="#authors" class="nav-link">Ads</a>
        </li> -->
        <!-- <li class="nav-item">
          <a href="#contact" class="nav-link">Results</a>
        </li> -->
      </ul>
    </div>
  </div>
      ...
      <div class="row">
        <div class="col-lg-6 text-center ml-auto mr-auto">
          ...
          <a href="" class="btn btn-outline-secondary btn-lg text-white">
            <i class="fas fa-arrow-right"> Showcase</i>
          </a>
        </div>
        <!-- <div class="col-lg-6">
      ...
      <div class="col-md-3">
        <div class="card text-center border-primary mb-resp">
          <div class="card-body">
            ...
            <p class="text-muted">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Sit, laudantium?</p>
          </div>
        </div>
      </div>
    ...
    <div class="row">
      <div class="col">
        <div class="info-header mb-5">
          ...
          <p class="lead pb-3">Lorem ipsum dolor sit amet consectetur adipisicing elit. Recusandae, nihil?</p>
        </div>
  ...
  <div class="container">
    <div class="row">
      <div class="col">
        <div class="info-header mb-5">
          ...
          <p class="lead">
            Lorem ipsum dolor sit amet consectetur, adipisicing elit. Laborum quis nostrum, sit corporis eveniet inventore.
          </p>
        </div>
      </div>
    </div>
    ...
    <div class="row">
      <div class="col-lg-3 col-md-6 col-sm-12">
        <div class="card">
          <div class="card-body">
            <img src="img/person1.jpg" alt="Susan Williams" class="img-fluid roundedicrucle w-50 mb-3">
            <h3>Susan Williams</h3>
            <h5 class="text-muted">Lead Writer</h5>
            <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Quaerat, nostrum sapiente possimus hic minus consectetur?</p>
      ...
      <div class="col-lg-3 col-md-6 col-sm-12"">
        <div class="card">
          <div class="card-body">
            <img src="img/person2.jpg" alt="Grace Smith" class="img-fluid roundedicrucle w-50 mb-3">
            <h3>Grace Smith</h3>
      ...
      <div class="col-lg-3 col-md-6 col-sm-12"">
        <div class="card">
          <div class="card-body">
            <img src="img/person3.jpg" alt="John Marston" class="img-fluid roundedicrucle w-50 mb-3">
            <h3>John Marston</h3>
      ...
      <div class="col-lg-3 col-md-6 col-sm-12"">
        <div class="card">
          <div class="card-body">
            <img src="img/person4.jpg" alt="Kevin Swanson" class="img-fluid roundedicrucle w-50 mb-3">
            <h3>Kevin Swanson</h3>
...
<section id="contact" class="bg-light py-5">
  <div class="container">
    <div class="row">
      <div class="col-lg-9">
        <h3>Get in Touch</h3>
        <p class="lead">Lorem ipsum dolor sit amet consectetur adipisicing elit. Adipisci, necessitatibus?</p>
        <form>
  ...
  <div class="container">
    <div class="row text-center">
      <div class="col-md-6 ml-auto">
        <p class="lead">
          Copyright &copy;Sparks Full-Stack <span id="year"></span>
        </p>
      </div>
    </div>
  </div>
